...
|  TS Forecasting  <br> Few Shot <br> Zero Shot  |  Informer   |  Time-LLM   | GPT-2 <br> llama2-7B <br> Decoder-Only |  [Time-LLM: Time Series Forecasting by Reprogramming Large Language Models](https://proceedings.mlr.press/v235/das24c.html) | [Pytorch](https://github.com/KimMeen/Time-LLM)  <br>![Stars](https://img.shields.io/github/stars/KimMeen/Time-LLM?color=critical&style=social) <br>![Forks](https://img.shields.io/github/forks/KimMeen/Time-LLM?color=critical&style=social)  | ICML 2024
