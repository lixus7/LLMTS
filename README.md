...
| TS Forecasting |  TimesNet | Prune |  Plug-in |  [Less is More: Unlocking Specialization of Time Series Foundation Models via Structured Pruning](https://arxiv.org/abs/2505.23195) | [Pytorch](https://github.com/SJTU-DMTai/Prune-then-Finetune)  <br>![Stars](https://img.shields.io/github/stars/SJTU-DMTai/Prune-then-Finetune?color=critical&style=social) <br>![Forks](https://img.shields.io/github/forks/SJTU-DMTai/Prune-then-Finetune?color=critical&style=social)  | NIPS 2025
| TS Forecasting | TimesNet |  SymTime | Encoder <br> DistilBERT |  [Synthetic Series-Symbol Data Generation for Time Series Foundation Models](https://arxiv.org/abs/2510.08445) | [Pytorch](https://github.com/wwhenxuan/SymTime)  <br>![Stars](https://img.shields.io/github/stars/wwhenxuan/SymTime?color=critical&style=social) <br>![Forks](https://img.shields.io/github/forks/wwhenxuan/SymTime?color=critical&style=social)  | NIPS 2025
| TS Forecasting |  BOOM <br>  GIFT <br> TimesNet |  TOTO | Transformer  <br> Decoder-Only |  [This Time is Different: An Observability Perspective on Time Series Foundation Models](https://arxiv.org/abs/2505.14766) | [Pytorch](https://github.com/DataDog/toto)  <br>![Stars](https://img.shields.io/github/stars/DataDog/toto?color=critical&style=social) <br>![Forks](https://img.shields.io/github/forks/DataDog/toto?color=critical&style=social)  | NIPS 2025
| TS Forecasting | TimesNet  |   ELF | Plug-in  |  [Lightweight Online Adaption for Time Series Foundation Model Forecasts](https://arxiv.org/abs/2502.12920) |  None? | ICML 2025
...
| TS Forecasting |  Chronos |  WaveToken  | Plug-in |  [Enhancing Foundation Models for Time Series Forecasting via Wavelet-based Tokenization](https://icml.cc/virtual/2025/poster/46131) | [Pytorch](https://github.com/amazon-science/chronos-forecasting/tree/wavetoken)  | ICML 2025
